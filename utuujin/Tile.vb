...
Public Class TileDatabase
	Private Shared m_tileData() As TileData = {
		...
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 07, .yTexCoord = 02, .texWidth = 1, .texHeight = 1 }, .solid = True  }, ' TILE_SHOP_0
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 08, .yTexCoord = 02, .texWidth = 1, .texHeight = 1 }, .solid = True  }, ' TILE_SHOP_1
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 09, .yTexCoord = 02, .texWidth = 1, .texHeight = 1 }, .solid = True  }, ' TILE_SHOP_2
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 07, .yTexCoord = 03, .texWidth = 1, .texHeight = 1 }, .solid = True  }, ' TILE_SHOP_3
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 08, .yTexCoord = 03, .texWidth = 1, .texHeight = 1 }, .solid = True  }, ' TILE_SHOP_4
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 09, .yTexCoord = 03, .texWidth = 1, .texHeight = 1 }, .solid = True  }, ' TILE_SHOP_5
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 10, .yTexCoord = 03, .texWidth = 1, .texHeight = 1 }, .solid = False }, ' TILE_SHOP_6
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 11, .yTexCoord = 03, .texWidth = 1, .texHeight = 1 }, .solid = True  }, ' TILE_SHOP_7
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 10, .yTexCoord = 02, .texWidth = 1, .texHeight = 1 }, .solid = True  }, ' TILE_SHOP_8
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 11, .yTexCoord = 02, .texWidth = 1, .texHeight = 1 }, .solid = False }, ' TILE_SHOP_9
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 10, .yTexCoord = 01, .texWidth = 1, .texHeight = 1 }, .solid = False }, ' TILE_SHOP_10
		New TileData With { .spriteDef = New SpriteDef With { .xTexCoord = 11, .yTexCoord = 01, .texWidth = 1, .texHeight = 1 }, .solid = True  }  ' TILE_SHOP_11   
	}
